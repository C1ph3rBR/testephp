...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST)) {
        ...
        if (!empty($_POST['medico'])) {
            ...
            $MedicoErro = 'Por favor digite o nome do Médico!';
            $validacao = False;
        }
        ...
        if (!empty($_POST['data'])) {
            ...
            $data_horaErro = 'Por favor selecione uma Data e hora!';
            $validacao = False;
        }
...
//Inserindo no Banco:
    if ($validacao) {
        ...
        $sql = "INSERT INTO consuta (nome, endereco, telefone, email,sexo,doutor,data_hora) VALUES(?,?,?,?,?,?,?)";
        $q = $pdo->prepare($sql);
        $q->execute(array($nome, $endereco, $telefone, $email,$sexo,$medico,$data_hora));
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="create.php" method="post">
                    ...
                    <div class="control-group  <?php echo !empty($nomeErro) ? 'echo($nomeErro) ' : ''; ?>">
                    ...
                    <div class="control-group <?php echo !empty($enderecoErro) ? 'echo($enderecoErro) ' : ''; ?>">
                    ...
                    <div class="control-group <?php echo !empty($telefoneErro) ? 'echo($telefoneErro) ' : ''; ?>">
                    ...
                    <div class="control-group <?php !empty($emailErro) ? '$echo($emailErro) ' : ''; ?>">
                    ...
                    <div class="control-group  <?php echo !empty($MedicoErro) ? 'echo($MedicoErro) ' : ''; ?>">
                        <label class="control-label">Médico</label>
                        <div class="controls">
                            <input size="50" class="form-control" name="medico" type="text" placeholder="Médico"
                                   value="<?php echo !empty($medico) ? $medico : ''; ?>">
                            <?php if (!empty($MedicoErro)): ?>
                                <span class="text-danger"><?php echo $MedicoErro; ?></span>
                            <?php endif; ?>
                        </div>
                    </div>

                    <div class="control-group <?php !empty($data_horaErro) ? 'echo($data_horaErro)' : ''; ?>">
                        <label class="control-label">Data e hora</label>
                        <div class="controls">
                            <input size="40" class="form-control" name="data" type="datetime-local" placeholder="Data"
                                   value="<?php echo !empty($data) ? $data : ''; ?>">
                            <?php if (!empty($data_horaErro)): ?>
                                <span class="text-danger"><?php echo $data_horaErro; ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
